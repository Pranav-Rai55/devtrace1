...
export default function Signup({ open = true, onClose = () => {} }) {
        ...
        <div className="px-5 sm:px-7 pb-6 sm:pb-7">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-6 w-full rounded-2xl bg-indigo-600 py-4 font-semibold hover:bg-indigo-500 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
